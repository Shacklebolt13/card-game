...
from src.testing_examples.services import student_create
from src.testing_examples.tests.factories import SchoolCourseFactory, SchoolFactory
from src.utils.tests import faker


class StudentCreateTests(TestCase):
    @patch("src.testing_examples.services.students.school_list_school_courses")
    @patch("src.testing_examples.services.students.roster_create")
